...
class TablaMembresiasNuevas{

    /*=============================================
    MOSTRAR LA TABLA DE MEMBRESIAS
    =============================================*/ 

    public function mostrarTablaMembresiasNuevas(){

        $valor = $_SESSION["empresa"];    

        $membresia = ControladorMembresias::ctrSelecMembresiasNuevas($valor);	
...
=============================================*/ 
$activarMembresiasNuevas = new TablaMembresiasNuevas();
$activarMembresiasNuevas -> mostrarTablaMembresiasNuevas();
