...
$("#nuevaEmpresa").change(function(){
  ...
  $('#nuevoTipoMembresia').html('<div class="loading"><div class="alert alert-primary" role="alert"><img src="images/loader.gif"/><br/>Procesando, por favor espere...</div></div>');
...
/* 
* TABLA PARA APUESTAS PERFIL
*/
  $('.tablaApuestasPerfil').DataTable({
    "ajax": "ajax/apuestas/tabla-apuestas-perfil.ajax.php?perfil="+$("#perfilOculto").val(),
    "deferRender": true,
    "retrieve": true,
    "processing": true,
    "pageLength": 10,
